            ...
            targetConnection = realBall:GetAttributeChangedSignal("target"):Connect(function()
                ...
                if currentTarget == myName then
                    ...
                    if curDistance <= 25 then
                            ...
                            if curDistance / maxSpeed < 0.18 then
                    ...
                    if (plr[currentTarget].Character.HumanoidRootPart.Position - character.HumanoidRootPart.Position).Magnitude > 25 then
                        closeRangecount = 0
                        spamCase = false
                    end
                end
    ...
    getgenv().HeartbeatConnection = game:GetService("RunService").Heartbeat:Connect(function(v)
        ...
        if ball then
            ...
            visualRange = maxSpeed / getgenv().config["Visual Range"]
